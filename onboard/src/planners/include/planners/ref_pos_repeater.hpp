...
class RefPosRepeater : public rclcpp::Node
{
public:
    RefPosRepeater();
...
private: 
    ...
    rclcpp::Subscription<geometry_msgs::msg::PoseStamped>::SharedPtr _ref_subscription;
    ...
    void _ref_callback(const geometry_msgs::msg::PoseStamped::SharedPtr msg);
...
int main(int argc, char ** argv)
{
  ...
  rclcpp::spin(std::make_shared<RefPosRepeater>());
  rclcpp::shutdown();
  return 0;
}
